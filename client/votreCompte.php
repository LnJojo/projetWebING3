...
if (!empty($_POST)) {
    if (isset($_POST['search'])) {                      ///Si on appuie sur le bouton rechercher dans la navbar
        ...
        if (checkSearch($search)) {
            ...
            $_SESSION["typeSearch"] ="specialite";
        ...
        if (checkSearchNomPrenom($search))
        {
            ...
            header("Refresh: votreCompte.php");
        }
    }
...
<body>
    <nav class="navbar navbar-light navbar-expand-md py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
            ...
            <div class="collapse navbar-collapse" id="navcol-3">
                ...
                <form method="POST" action="votreCompte.php"><input type="search" name="text"><button class="btn btn-primary" type="submit" name="search">Rechercher</button></form>
            </div>
        </div>
    </nav>
    <div id="banner">
    ...
    <div id="information">
        <div class="row">
            ...
            <div class="col">
                <h2 id="nom"><?php echo $_SESSION["nom"]; ?></h2>
                ...
                <h2 id="adresse" style="color: rgb(0,0,0);"><?php echo $_SESSION["adresse"]; ?></h2>
                <h2 id="numero" style="color: rgb(0,0,0);"><?php echo $_SESSION["id"]; ?></h2>
            </div>
        </div>

    </div>
    <div style="margin:30px; text-align:center;">
        <form method="POST" action="votreCompte.php" style="background-color:gray;padding:10px">
