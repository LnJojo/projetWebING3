...
<body>
    ...
    <?php
    if (!empty($_POST)) {
        if (isset($_POST['annuler'])) {     ///Si on appuie sur un bouton pour annuler le rdv
            annulerRdv($_POST['idRDV']);    ///On appelle la fonction pour annuler avec l'id du rdv selectionne
        ...
        if (isset($_POST['search'])) {      ///Si on appuie sur le bouton rechercher dans la navbar
            ...
            if (checkSearchNomPrenom($search)) {
                ...
                header("Refresh: Rendez-Vous.php");         ///Sinon on refresh la page actuelle
            }
        }
    }
    ...
    <div class="table-responsive" id="tab">
        <table class="table">
            ...
            <tbody>
                <?php
                mesRdv($_SESSION["id"]);            ///Affichage des rdv
                ?>
    ...
    <footer class="text-white bg-dark rdv">
