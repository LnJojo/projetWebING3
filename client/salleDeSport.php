...
if (!empty($_POST)) {
    if (isset($_POST['search'])) {                          ///Si on appuie sur le bouton rechercher dans la navbar  
        ...
        if (checkSearchNomPrenom($search))
        {
            ...
            header("Refresh: salleDeSport.php");
        }
        ...
        <div class="container" id="gallery">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style="font-weight: bold;">NOTRE SALLE DE SPORT</h2>
                    <p class="w-lg-50">Profite d'un accès 6j/7, de 7h à 16h au 37 quai de Grenelle. Viens pour t'entraîner, te surpasser et réaliser tes objectifs.</p>
                </div>
            </div>
            <div class="row gx-2 gy-2 row-cols-1 row-cols-md-2 row-cols-xl-3 photos" data-bss-baguettebox="">
                <div class="col item"><a href="../assets/img/Salle%20de%20sports/Salle-de-musculation.jpg"><img class="img-fluid" src="../assets/img/Salle%20de%20sports/Salle-de-musculation.jpg"></a></div>
                <div class="col item"><a href="../assets/img/Salle%20de%20sports/salle%20de%20musculation%202.jpg"><img class="img-fluid" src="../assets/img/Salle%20de%20sports/salle%20de%20musculation%202.jpg"></a></div>
                <div class="col item"><a href="../assets/img/Salle%20de%20sports/Salle%20de%20musculation%203.jpg"><img class="img-fluid" src="../assets/img/Salle%20de%20sports/Salle%20de%20musculation%203.jpg"></a></div>
                <div class="col item"><a href="../assets/img/Salle%20de%20sports/Salle%20de%20musculation%204.jpg"><img class="img-fluid" src="../assets/img/Salle%20de%20sports/Salle%20de%20musculation%204.jpg"></a></div>
                <div class="col item"><a href="../assets/img/Salle%20de%20sports/Salle%20de%20musculation%205.jpg"><img class="img-fluid" src="../assets/img/Salle%20de%20sports/Salle%20de%20musculation%205.jpg"></a></div>
                <div class="col item"><a href="../assets/img/Salle%20de%20sports/salle%20de%20musculation%206.jpg"><img class="img-fluid" src="../assets/img/Salle%20de%20sports/salle%20de%20musculation%206.jpg"></a></div>
            </div>
        </div>
    </section>
