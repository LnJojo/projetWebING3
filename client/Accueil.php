...
if (!empty($_POST)) {
    if (isset($_POST['search'])) {                      ///Si on appuie sur le bouton rechercher dans la navbar
        ...
        if (checkSearchNomPrenom($search))
        {
            ...
            header("Refresh: Accueil.php");             ///Sinon on refresh la page actuelle
        }
    }
...
<body>
    ...
    <div id="event">
        <div class="text-section">
            <h1>Portes ouvertes de l'Omnes Sports</h1>
            <p>Réservez votre samedi pour les portes ouvertes d'Omnes Sports. Vous pourrez discuter avec nos différents coachs sur place.</p><button class="btn btn-primary" type="button">En savoir plus</button>
        </div>
    </div>
    <div id="presentation" style="background-color:#303030">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto text-presentation" style="background-color:#818a9a;border-radius:10px;margin:30px;padding:10px">
                <h2 style="font-weight: bold;">OMNES SPORTS</h2>
                <p class="text-center w-lg-50">Bienvenue sur notre site Omnes Sports. Nous sommes présents sur de nombreux domaines, vous trouverez donc forcément une activités sportives qui vous correspond.</p>
            </div>
        </div>
    </div>
    <div id="gallery-coachs" class="gallery">
        <div class="row">
            <div class="col-4">
                <div class="card"><img class="card-img-top w-100 d-block" src="../assets/img/Accueil/sports-man-spend-time-in-morning-gym.jpg">
                    <div class="card-body">
                        <h4 class="text-center card-title" style="font-weight: bold;font-size: 28px;">Ethan Dubois</h4>
                        <p class="card-text" style="text-align: center;font-weight: bold;">Coach Musculation</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="card"><img class="card-img-top w-100 d-block" src="../assets/img/Accueil/swimming-coach-standing-by-the-pool-checking-swimming-records-holding-clipboard.jpg">
                    <div class="card-body">
                        <h4 class="text-center card-title" style="font-weight: bold;font-size: 28px;">Nathanaël Dupont</h4>
                        <p class="card-text" style="font-weight: bold;text-align: center;">Coach Natation</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="card"><img class="card-img-top w-100 d-block" src="../assets/img/Accueil/coach%20basketball.jpg">
                    <div class="card-body">
                        <h4 class="card-title" style="font-weight: bold;text-align: center;font-size: 28px;">Stéphane Plaza</h4>
                        <p class="card-text" style="font-weight: bold;text-align: center;">Coach Basketball</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="simple-slider">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" style="background: url(../assets/img/Accueil/slider1.jpg) center center / cover no-repeat;"></div>
                    <div class="swiper-slide" style="background: url(../assets/img/Accueil/slider2.jpg) center center / cover no-repeat;"></div>
                    <div class="swiper-slide" style="background: url(../assets/img/Accueil/slider3.jpg) center center / cover no-repeat;"></div>
                </div>
    ...
    <div class="map-contact">
        <section id="map" class="position-relative py-4 py-xl-5">
            <div class="container position-relative" id="map">
                <div class="row">
                    <div class="col"><iframe allowfullscreen="" frameborder="0" loading="lazy" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyD6baoqxdOV4PIYYPHFCzfK99k_LQB7TB0&amp;q=37+quai+de+grenelle&amp;zoom=17" width="100%" height="100%"></iframe></div>
                    <div class="col-md-6 col-xl-4">
                        <div>
                            <form id="contact-us" class="p-3 p-xl-4" method="post">
                                <h4>Contactez nous</h4>
                                <p class="text-muted">Veuillez renseigner les différents champs</p>
