...
if (!empty($_POST)) {                   ///On verifie les differents input s'ils ne sont pas vide
    ...
    if ($specialite == "") {
        $erreur .= "Le champ specialite est vide. <br>";
    }

    if ($erreur == "") {
        $user = ajoutCoach($nom, $prenom, $email, $pw, $specialite);
        if ($user == false) {
            $return = "Le compte n'a pas pu être créé, veullez saisir un autre email";
        } 
        else{
            echo "Le coach a été créé.";
        }
    }
    else {
...
<body>
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" action="ajoutCoachs.php" method="POST">
                ...
                <div class="row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Spécialité</label></div>
                    <div class="col-sm-6 input-column"><select class="form-select" name="specialite">
                            <optgroup label="Choisir la spécialité">
                                ...
                                <option value="tatation">Natation</option>
                                <option value="plongeon">Plongeon</option>
                            </optgroup>
                        </select></div>
                </div><button class="btn btn-light submit-button" type="submit">Créer</button>
            </form>
        </div>
    </div>
