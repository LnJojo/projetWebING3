...
<head>
    <title>Inscription Admin Omnes Sports</title>
    <meta charset="utf_8">
...
<body>
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" action="inscriptionAdmin.php" method="POST">
                ...
                <button class="btn btn-light submit-button" type="submit">S'inscrire</button><a href="loginAdmin.php"><button id="connect" class="btn btn-light" type="button">Se connecter</button></a>
            </form>
        </div>
    </div>
